...
export default function NexuStoreRD() {
  ...
  const ventasPorMes = MESES.map((m, i) => {
    const base = [0,0,145000,150000,95000,120000,0,0,0,0,0,0];
    return { mes: m, valor: base[i] || 0 };
  });
            ...
            <div className="fade-in">
              ...
              <div style={{ display:"grid", gridTemplateColumns:"1.5fr 1fr", gap:16, marginBottom:16 }}>
                <div className="card-hover border-glow" style={{ background:"#080808", border:"1px solid #00d4ff20", borderRadius:6, padding:"24px" }}>
                  <div style={{ fontFamily:"Orbitron,monospace", fontSize:11, color:"#00d4ff", letterSpacing:2, marginBottom:20 }}>◈ VENTAS POR MES — 2025</div>
